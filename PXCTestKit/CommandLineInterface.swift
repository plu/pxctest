    ...
    open static func bootstrap() {
        Group {
            $0.command("run-tests",
                       ...
                       VaradicOption<Destination>("output", [], description: "A comma-separated set of key=value pairs describing the destination to use, just like xcodebuild -destination."),
